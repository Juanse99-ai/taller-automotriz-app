...
| `20260915_001_gastos.sql` | Crea la tabla `gastos`: los gastos fijos de cada mes, sus pagos y los gastos sueltos (pantalla Gastos). Aplicada el 15 sep 2026 | No |
| `20260915_002_gastos_fijos_iniciales.sql` | **Opcional.** Carga los gastos fijos del modelo: arriendo del local de repuestos $1.000.000, arriendo del taller $500.000, crédito $2.500.000 el día 15 y tres sueldos fijos ($960.000, $1.200.000 y $1.000.000). Aplicada el 15 sep 2026 | **Solo inserta** en `gastos` (6 filas); no repite si ya existen |
